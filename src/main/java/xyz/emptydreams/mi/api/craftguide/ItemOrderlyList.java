...
/**
 * 通过物品对象工作的有序合成表，不支持矿词
 * @author EmptyDreams
 * @version V1.0
 */
@SuppressWarnings({"unchecked", "unused"})
public class ItemOrderlyList extends GuideList<Item, ItemStack> {
	 ...
	 */
	public ItemOrderlyList(int width, int height, Item out, int amount) {
	 ...
	 * @throws NullPointerException 如果out == null
	 */
	public ItemOrderlyList(Item out, int amount) {
		this(3, 1, out, amount);
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof ItemOrderlyList)) return false;
		ItemOrderlyList list = (ItemOrderlyList) o;
