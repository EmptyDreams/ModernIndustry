...
import top.kmar.mi.api.regedits.block.WorldCreater;
import top.kmar.mi.api.regedits.sorter.BlockSorter;
...
public class BlockRegistryMachine extends AutoRegisterMachine<AutoBlockRegister, Object> {
	...
	public void registry(Class<?> clazz, AutoBlockRegister annotation, Object data) {
		...
		Block block = RegisterHelp.newInstance((Class<? extends Block>) clazz, (Object[]) null);
		...
		if (!RegisterHelp.assignField(block, field, block)) return;
