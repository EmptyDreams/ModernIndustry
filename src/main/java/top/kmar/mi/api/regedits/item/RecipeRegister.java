package top.kmar.mi.api.regedits.item;
...
public final class RecipeRegister {
    ...
    public static void registry(ItemHoe hoe, String material) {
        HOES.put(StringUtil.checkNull(hoe, "hoe"), StringUtil.checkNull(material, "material"));
    }
    ...
    public static void registry(ItemAxe axe, String material) {
        AXES.put(StringUtil.checkNull(axe, "axe"), StringUtil.checkNull(material, "material"));
    }
    ...
    public static void registry(ItemPickaxe pickaxe, String material) {
        PICKAXES.put(StringUtil.checkNull(pickaxe, "pickaxe"), StringUtil.checkNull(material, "material"));
    }
    ...
    public static void registry(ItemSpade spade, String material) {
        SPADES.put(StringUtil.checkNull(spade, "spade"), StringUtil.checkNull(material, "material"));
    }
    ...
    public static void registry(ItemSword sword, String material) {
        SWORDS.put(StringUtil.checkNull(sword, "sword"), StringUtil.checkNull(material, "material"));
    }
    ...
    public static void registry(ItemArmor armor, String material) {
        ARMORS.put(StringUtil.checkNull(armor, "armor"), StringUtil.checkNull(material, "material"));
    }
