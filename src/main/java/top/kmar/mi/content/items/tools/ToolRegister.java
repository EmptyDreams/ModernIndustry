...
import top.kmar.mi.api.tools.item.MIHoe;
import top.kmar.mi.api.tools.item.MIPickaxe;
import top.kmar.mi.api.tools.item.MISpade;
import top.kmar.mi.api.tools.item.MISword;
...
import static top.kmar.mi.content.items.tools.MITool.COPPER;
import static top.kmar.mi.content.items.tools.MITool.COPPER_ARMOR;
...
public class ToolRegister {
	...
	public static final Item ITEM_COPPER_PICKAXE = new MIPickaxe(COPPER)
														.setRegistry(ModernIndustry.MODID, NAME_COPPER_PICKAXE);
	/** 青铜镐 */
	...
	public static final Item ITEM_BRONZE_PICKAXE = new MIPickaxe(IRON)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_PICKAXE);
	...
	public static final Item ITEM_COPPER_SWORD = new MISword(COPPER, 5, -2.5D)
			                                             .setRegistry(ModernIndustry.MODID, NAME_COPPER_SWORD);
	...
	public static final Item ITEM_BRONZE_SWORD = new MISword(IRON, 6, -2.4000000953674316D)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_SWORD);
	
	/** 铜铲 */
	public static final String NAME_COPPER_SHOVEL = "copper_shovel";
	public static final Item ITEM_COPPER_SHOVEL = new MISpade(COPPER).setRegistry(ModernIndustry.MODID, NAME_COPPER_SHOVEL);
	/** 青铜铲 */
	public static final String NAME_BRONZE_SHOVEL = "bronze_shovel";
	public static final Item ITEM_BRONZE_SHOVEL = new MISpade(IRON).setRegistry(ModernIndustry.MODID, NAME_BRONZE_SHOVEL);
	
	/** 铜锄 */
	public static final String NAME_COPPER_HOE = "copper_hoe";
	public static final Item ITEM_COPPER_HOE = new MIHoe(COPPER).setRegistry(ModernIndustry.MODID, NAME_COPPER_HOE);
	/** 青铜锄 */
	public static final String NAME_BRONZE_HOE = "bronze_hoe";
	public static final Item ITEM_BRONZE_HOE = new MIHoe(IRON).setRegistry(ModernIndustry.MODID, NAME_BRONZE_HOE);
	...
	public static final Item ITEM_COPPER_HELMET = new MIArmor(COPPER_ARMOR, HEAD)
														.setRegistry(ModernIndustry.MODID, NAME_COPPER_HELMET);
	/** 青铜头盔 */
	...
	public static final Item ITEM_BRONZE_HELMET = new MIArmor(ArmorMaterial.IRON, HEAD)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_HELMET);
	...
	public static final Item ITEM_COPPER_CHEST = new MIArmor(COPPER_ARMOR, CHEST)
														.setRegistry(ModernIndustry.MODID, NAME_COPPER_CHEST);
	/** 青铜胸甲 */
	...
	public static final Item ITEM_BRONZE_CHEST = new MIArmor(ArmorMaterial.IRON, CHEST)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_CHEST);
	...
	public static final Item ITEM_COPPER_LEG = new MIArmor(COPPER_ARMOR, LEGS)
														.setRegistry(ModernIndustry.MODID, NAME_COPPER_LEG);
	/** 青铜护腿 */
	...
	public static final Item ITEM_BRONZE_LEG = new MIArmor(ArmorMaterial.IRON, LEGS)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_LEG);
	...
	public static final Item ITEM_COPPER_BOOT = new MIArmor(COPPER_ARMOR, FEET)
														.setRegistry(ModernIndustry.MODID, NAME_COPPER_BOOT);
	/** 青铜靴子 */
	...
	public static final Item ITEM_BRONZE_BOOT = new MIArmor(ArmorMaterial.IRON, FEET)
														.setRegistry(ModernIndustry.MODID, NAME_BRONZE_BOOT);
